...
public class UpdatePersonalEventResource {
    ...
    public Response doUpdatePersonalEvent(UpdateEventData data, @Context HttpHeaders headers, @Context HttpServletRequest request) {
        ...
        try {
            ...
            final Entity personalEventCached = getPersonalEventCached(data.id);
            ...
            if (isPersonalEventCached) {
                ...
                memcachePersonalEvents.put(String.format(MemcacheUtils.PERSONAL_EVENT_ENTITY_KEY, data.id), personalEventOnDB);
            }
            ...
            if (didPersonalEventChanged(invalidFormatUpdates, data.updateEntries)) {
                ...
                memcachePersonalEvents.put(String.format(MemcacheUtils.PERSONAL_EVENT_ENTITY_KEY, data.id), updatePersonalEvent);
            }
            txn.commit();
